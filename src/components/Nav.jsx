    ...
    <nav className="w-[100%] h-[120px] flex items-center px-[16px] bg-[#fff9] backdrop-blur-sm sticky top-0 z-50 border-b border-solid border-[#0003]">
      <div className="w-[100%] sm:w-[600px] md:w-[735px] lg:w-[990px] xl:w-[1248px] mx-auto h-auto flex flex-row items-center justify-between">
        ...
        <div
          className={`absolute ${
            isOpen ? "block" : "hidden"
          } lg:hidden absolute top-0 left-0 w-[100%] px-[16px] shadow-lg transition-all duration-300 ease-in-out bg-[rgba(255,255,255,0.9)] ${
            isOpen ? "z-[50]" : "z-[-100]"
          } ${
            isOpen
        ...
        >
          <ul className="flex flex-col items-left gap-4 py-6">
            ...
            <li>
              <div className="w-[260px] flex flex-row gap-[10px] items-center relative">
                <button
                  className="w-[74px] h-auto border border-[#3333] border-solid rounded-[6px] px-[12px] py-[6px] flex flex-row justify-between items-center shadow-sm z-[100]"
                ...
                {lang.modal && (
                  <div className="w-[100px] h-[110px] absolute bg-[#fff] top-[100%] left-0 rounded-[6px] z-[90] p-[4px] border border-solid border-[#0003] flex flex-col items-center">
                    {languages.map((item) => (
      ...
      {lang.modal === true && (
        <div
          className="w-[100%] h-[100vh] absolute top-0 left-0 z-[30]"
